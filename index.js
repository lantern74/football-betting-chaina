...
async function postData() {
    ...
    try {
        ...
        for(i=0; i<response.data.data.matches.length; i++) {
            console.log('matchDate:', response.data.data.matches[i].matchDate);
            console.log('homeTeam:', response.data.data.matches[i].homeTeam);
            console.log('awayTeam:', response.data.data.matches[i].awayTeam);
        }
